...
import { fetchFeedbacks } from "../redux/feedback/feedbackSlice";
  ...
  return (
    <div className="custom-container xl:flex block items-start justify-center font-vietnam">
      ...
      <div className="w-full xl:w-1/2 px-6 xl:px-0">
        <h1
          className="text-red-wine custom-3xl:text-[60px] custom-2xl:text-[50px] custom-xl:text-[45px] text-[35px] font-bold xl:text-left text-center
